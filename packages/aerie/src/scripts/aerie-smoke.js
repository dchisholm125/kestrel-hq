...
To run test:
    ...
    node /home/ubuntu/kestrel-hq/packages/aerie/src/scripts/aerie-smoke.js 
*/
...
async function main(){
  // repo root is four levels up from packages/aerie/src/scripts
